...
namespace HuaCards.Data;

public class HuaCardsDbContext : DbContext
{
    ...
    public HuaCardsDbContext()
    {
        var docs = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments);
        var dir = Path.Combine(docs, "HuaCards");
        Directory.CreateDirectory(dir);
        _dbPath = Path.Combine(dir, "huacards.db");
